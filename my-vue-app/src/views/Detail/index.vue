<template>
  <div class="xtx-goods-page" v-if="detailGoods.categories">
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          <el-breadcrumb-item :to="{ path: '/' }">首页</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/${detailGoods.categories[1].id}` }">{{detailGoods.categories[1].name  }} </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/category/subCategory/${detailGoods.categories[0].id}` }">{{ detailGoods.categories[0].name }}</el-breadcrumb-item>
          <el-breadcrumb-item>{{ detailGoods.name }}</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 商品信息 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                <img v-for="item2 in detailGoods.details.pictures" :key="item2" :src="item2" alt="">
                </div>
              </div>
            </div>
            <!-- 24热榜+专题推荐 -->
